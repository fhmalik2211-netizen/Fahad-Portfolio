    ...
    >
      ...
      <div className="relative mx-auto max-w-[1240px]">
        ...
        <div className="mt-14 grid gap-14 lg:grid-cols-[1.2fr_.8fr] lg:gap-20">
          ...
          <div className="border-t border-[var(--line)] pt-5 lg:mt-2">
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-1">
              <div>
                <p className="m-0 text-[.68rem] font-bold uppercase tracking-[.15em] text-[var(--muted)]">Email</p>
                <a className="mt-3 inline-block text-[1.05rem] text-[var(--foreground)] underline decoration-[var(--line)] underline-offset-8 transition-colors hover:text-[var(--accent)] hover:decoration-[var(--accent)]" href="mailto:unknownfahai@gmail.com">
                  unknownfahai@gmail.com
                </a>
              </div>
              <div>
                <p className="m-0 text-[.68rem] font-bold uppercase tracking-[.15em] text-[var(--muted)]">Based in</p>
                <p className="mt-3 text-[1.05rem] text-[var(--foreground)]">Chiniot, Sargodha</p>
              </div>
              <div>
                <p className="m-0 text-[.68rem] font-bold uppercase tracking-[.15em] text-[var(--muted)]">Best for</p>
                <p className="mt-3 max-w-[280px] text-[1.05rem] leading-[1.5] text-[var(--foreground)]">Websites, product builds, and thoughtful fixes.</p>
              </div>
            </div>
